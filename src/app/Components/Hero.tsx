...
export function Hero() {
    return (
      ...
      Start for free
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1 h-full w-full max-w-6xl mx-auto  rounded-xl items-center justify-center w-full h-auto h-auto">
