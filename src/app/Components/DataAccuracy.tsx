...
export default function DataAccuracy() {
  return (
    <div className="min-h-screen w-full py-16 overflow-hidden"
         style={{
           backgroundImage: `url(${before.src})`,  // Set the 'before' image as the background
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-4 lg:gap-0 max-w-6xl mx-auto h-full w-full lg:mx-[100px] lg:pl-[180px] ">
          <div className="flex justify-center items-center px-[20px]">
            <Image src={before} height={380} width={370} alt="Before image" className="lg:mr-[-30px]" />
          </div>
          <div>
            <Image src={after} height={450} width={450} alt="After image" className="ml-14 lg:m-[-10px] lg:mt-[2px]" />
          </div>
        </div>
      </div>
    </div>
